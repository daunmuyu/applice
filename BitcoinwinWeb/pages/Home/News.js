...
var News = /** @class */ (function (_super) {
    ...
    Object.defineProperty(News.prototype, "needLogin", {
        get: function () {
            return false;
        },
        enumerable: true,
    ...
    Object.defineProperty(News.prototype, "statusBarStyle", {
        get: function () {
    ...
    News.prototype.onNavigationPushed = function () {
        _super.prototype.onNavigationPushed.call(this);
        this.loadData();
    };
    News.prototype.itemClick = function (item) {
        //if (item.link) {
    ...
    News.prototype.loadData = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, CoinDogApi.liveList(this, this.model.pageNumber, 100)];
                    case 2:
                        ret = _a.sent();
    ...
    News.prototype.loadMore = function () {
        this.loadData();
    };
    return News;
}(BaseComponent));
