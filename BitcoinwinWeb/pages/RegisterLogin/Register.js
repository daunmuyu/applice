...
var html = require("./register.html");
var Register = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Register.prototype, "needLogin", {
        get: function () {
            return false;
        },
        enumerable: true,
    ...
    Object.defineProperty(Register.prototype, "statusBarStyle", {
        get: function () {
    ...
    Register.prototype.onNavigationPushed = function () {
        var _this = this;
        _super.prototype.onNavigationPushed.call(this);
        setTimeout(function () {
            AccountCenterApi.GetCountryInfoList(_this, function (ret, err) {
                _this.model.isBusy = false;
                if (err)
                    showError(err);
                else {
                    ret.forEach(function (item) {
                        _this.model.countries.push(item);
                    });
                    _this.model.selectedCountry = "86";
                }
            });
        }, 100);
    };
    Register.prototype.read_zc = function () {
    ...
    Register.prototype.read_fx = function () {
        var page = new WebBrowser({
            src: ApiHelper.ResourceAddress + "/RegistrationAgreement." + this.model.textRes.langName.replace("-", "_") + ".html",
            fullScreen: false,
    ...
    Register.prototype.sendsms = function () {
        var _this = this;
        ...
        AccountCenterApi.SendSmsCode(this, this.model.username, parseInt(this.model.selectedCountry), 1, function (ret, err) {
            _this.model.isBusy = false;
            if (err)
                showError(err);
            else {
    ...
    Register.prototype.changeSeconds = function () {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/];
                    case 4:
                        if (!!this.model.agree) return [3 /*break*/, 6];
                        return [4 /*yield*/, alertWindow(this.model.textRes.items["请阅读并同意注册协议"])];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                    case 6:
                        this.model.isBusy = true;
                        this.recordAction("Regist_注册按钮");
                        AccountCenterApi.CheckPhoneSmsCode(this, this.model.username, this.model.verifyCode, 1, function (ret, err) {
                            if (err) {
                                _this.model.isBusy = false;
                                showError(err);
                            }
                            else {
                                AccountCenterApi.Register(_this, _this.model.username, _this.model.pwd1, _this.model.selectedCountry, function (ret, err) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                ...
                                                showError(err);
                                                return [3 /*break*/, 3];
                                            case 1: return [4 /*yield*/, alertWindow(this.model.textRes.items["注册成功"])];
                                            case 2:
                                                _a.sent();
                                                navigation.pop();
                                                _a.label = 3;
